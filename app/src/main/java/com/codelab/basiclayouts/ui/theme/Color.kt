...
val darkPurple = Color(16, 7, 43)
val text = Color.White
val darkBlue = Color(27,30,41)
val lightPurple = Color(142,43,200)
val lightBlue = Color(53,146,254)
val veryLightPurple = Color(78,61,97)
